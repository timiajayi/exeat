<?php
  ...
  // get all exeats that have been declined
  $select = "SELECT * FROM exeats WHERE status=\"2\"";
        ...
        <div class=\"panel panel-danger\">
          <div class=\"panel-heading\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Click to see more\">
            <h4 class=\"panel-title\">
              <a data-toggle=\"collapse\" class=\"text-uppercase\" href=\"#collapse".$row['id']."\">".$row['type']." Exeat</a>
            </h4>
          </div>
          <div id=\"collapse".$row['id']."\" class=\"panel-collapse collapse\">
            <div class=\"panel-body\">
            <p>Reason:  <kbd>".$row['reason']."</p></h2>
            <p>Intended Depart Date:  <kbd>".$row['leave_date']."</kbd></p>
            <p>Intended Return Date:  <kbd>".$row['return_date']."</kbd></p>
            </div>
            <div class=\"panel-footer\">
            <h4>Declined by:  ".$staffFirstName." ".$staffLastName." ".$staffNum."</h4>
          </div>
        </div>
      </div>
      </div>";
